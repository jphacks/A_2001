<template>
  <div class="animated fadeIn">
    <b-row>
      ...
      <b-col sm="6">
        <b-card>
          <div slot="header"><strong>Company</strong> <small>Form</small></div>
          <b-form-group>
    ...
    <b-row>
      <b-col md="6">
        <b-card>
          <div slot="header"><strong>Basic Form</strong> Elements</div>
          <b-form-group
          ...
          >
            ...
            >
              <b-form-checkbox :plain="true" value="1"
                >Option 1</b-form-checkbox
              >
              <b-form-checkbox :plain="true" value="2"
                >Option 2</b-form-checkbox
              >
              <b-form-checkbox :plain="true" value="3"
                >Option 3</b-form-checkbox
              >
            </b-form-checkbox-group>
          </b-form-group>
            ...
            <b-form-checkbox-group id="basicCustomCheckboxes" stacked>
              <div class="custom-control custom-checkbox">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="customChk1"
                  >Option 1</label
                >
              </div>
              <div class="custom-control custom-checkbox">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="customChk2"
                  >Option 2</label
                >
              </div>
              <div class="custom-control custom-checkbox">
                <input
                  ...
                  value="3"
                />
                <label class="custom-control-label" for="customChk3"
                  >Option 3</label
                >
              </div>
            </b-form-checkbox-group>
            ...
            <b-form-checkbox-group id="basicInlineCustomCheckboxes">
              <div class="custom-control custom-checkbox custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="customInChk1"
                  >Option 1</label
                >
              </div>
              <div class="custom-control custom-checkbox custom-control-inline">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="customInChk2"
                  >Option 2</label
                >
              </div>
              <div class="custom-control custom-checkbox custom-control-inline">
                <input
                  ...
                  value="3"
                />
                <label class="custom-control-label" for="customInChk3"
                  >Option 3</label
                >
              </div>
            </b-form-checkbox-group>
        ...
        <b-card>
          <div slot="header"><strong>Inline</strong> Form</div>
      ...
      <b-col md="6">
        <b-card>
          <div slot="header"><strong>Horizontal</strong> Form</div>
          <b-form-group
            label="Email"
        ...
        <b-card>
          <div slot="header"><strong>Normal</strong> Form</div>
          <b-form-group
            validated
            label="Email"
        ...
        <b-card no-body :no-block="true">
          <div slot="header">Input <strong>Grid</strong></div>
          <b-card-body>
        ...
        <b-card>
          <div slot="header">Input <strong>Sizes</strong></div>
          <b-form-group
            label="Small input"
            label-for="smInput"
            label-size="sm"
    ...
    <b-row>
      <b-col sm="12" md="6">
        <b-card no-body :no-block="true">
          <div slot="header"><strong>Validation feedback</strong> Form</div>
          <b-card-body>
            <b-form-group>
              <label class="col-form-label" for="inputIsValid"
            ...
            <b-form-group>
              <label class="col-form-label" for="inputIsInvalid"
    ...
    <b-row>
      <b-col sm="4">
        <b-card>
          <div slot="header"><strong>Icon/Text</strong> Groups</div>
          <b-form-group>
            <b-input-group>
          ...
          <b-form-group>
            <b-input-group>
              ...
              <b-input-group-append
                ><b-input-group-text
                  ><i class="fa fa-envelope-o"></i></b-input-group-text
              ></b-input-group-append>
            </b-input-group>
          </b-form-group>
          <b-form-group>
      ...
      <b-col sm="4">
        <b-card>
          <div slot="header"><strong>Buttons</strong> Groups</div>
          <b-form-group>
            <b-input-group>
              <!-- Attach Left button -->
              <b-input-group-prepend>
      ...
      <b-col sm="4">
        <b-card>
          <div slot="header"><strong>Dropdowns</strong> Groups</div>
          <b-form-group>
            <b-input-group>
              <!-- Attach Left button -->
              <b-input-group-prepend>
      ...
      <b-col md="6">
        <b-card>
          ...
          <div slot="footer">
            ...
            <b-button type="button" class="btn btn-sm btn-warning"
              >Action</b-button
            >
            <b-button type="button" class="btn btn-sm btn-info"
              >Action</b-button
            >
    ...
    <b-row>
        ...
        <b-card>
          ...
          <b-form-group>
            <b-input-group>
              <b-input-group-prepend
                ><b-input-group-text
                  >Email</b-input-group-text
                ></b-input-group-prepend
              >
              <b-form-input type="email"></b-form-input>
              <b-input-group-append
                ><b-input-group-text
                  ><i class="fa fa-envelope"></i></b-input-group-text
              ></b-input-group-append>
            </b-input-group>
          </b-form-group>
          <b-form-group>
            <b-input-group>
              <b-input-group-prepend
                ><b-input-group-text
                  >Password</b-input-group-text
                ></b-input-group-prepend
              >
              <b-form-input type="password"></b-form-input>
              <b-input-group-append
                ><b-input-group-text
                  ><i class="fa fa-asterisk"></i></b-input-group-text
              ></b-input-group-append>
            </b-input-group>
          </b-form-group>
      ...
      <b-col sm="4">
        <b-card>
          ...
          <div class="form-group form-actions">
            <b-button type="submit" class="btn btn-sm btn-secondary"
              >Submit</b-button
            >
          </div>
        </b-card>
        ...
        <b-card no-body>
          <div slot="header">
            ...
            <div class="card-actions">
              ...
              ></a>
              <b-btn v-b-toggle.collapse1 class="btn btn-minimize"
