        ...
        <b-col cols="12" md="6">
          <b-card header-tag="header" footer-tag="footer">
            ...
            <div>
              ...
              <!-- Using value -->
              <b-btn v-b-toggle="'collapse2'" class="m-1"
                >Toggle Collapse</b-btn
              >
            ...
            <div role="tablist">
              <b-card no-body class="mb-1">
                <b-card-header header-tag="header" class="p-1" role="tab">
                  <b-btn v-b-toggle.accordion1 block href="#" variant="info"
                    >Accordion 1</b-btn
                  >
                </b-card-header>
                <b-collapse
              ...
              <b-card no-body class="mb-1">
                <b-card-header header-tag="header" class="p-1" role="tab">
                  <b-btn v-b-toggle.accordion2 block href="#" variant="info"
                    >Accordion 2</b-btn
                  >
                </b-card-header>
                <b-collapse
              ...
              <b-card no-body class="mb-1">
                <b-card-header header-tag="header" class="p-1" role="tab">
                  <b-btn v-b-toggle.accordion3 block href="#" variant="info"
                    >Accordion 3</b-btn
                  >
                </b-card-header>
                <b-collapse
