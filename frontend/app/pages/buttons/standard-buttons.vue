    ...
    <b-row>
      <b-col md="6">
        ...
        <b-card>
          ...
          <b-button variant="primary"
            ><i class="fa fa-star"></i>&nbsp; Primary</b-button
          >
          <b-button variant="secondary"
            ><i class="fa fa-lightbulb-o"></i>&nbsp; Secondary</b-button
          >
          <b-button variant="success"
            ><i class="fa fa-magic"></i>&nbsp; Success</b-button
          >
          <b-button variant="warning"
            ><i class="fa fa-map-marker"></i>&nbsp; Warning</b-button
          >
          <b-button variant="danger"
            ><i class="fa fa-rss"></i>&nbsp; Danger</b-button
          >
          <b-button variant="link"
            ><i class="fa fa-link"></i>&nbsp; Link</b-button
          >
        </b-card>
        <b-card>
          <div slot="header">
        ...
        <b-card>
          ...
          <b-button size="lg" variant="primary" :disabled="true"
            >Primary</b-button
          >
          <b-button size="lg" variant="secondary" :disabled="true"
            >Secondary</b-button
          >
          <b-button size="lg" variant="success" :disabled="true"
            >Success</b-button
          >
          <b-button size="lg" variant="info" :disabled="true">Info</b-button>
          <b-button size="lg" variant="warning" :disabled="true"
            >Warning</b-button
          >
          <b-button size="lg" variant="danger" :disabled="true"
            >Danger</b-button
          >
        ...
        <b-card>
          ...
          <b-button variant="primary" :pressed.sync="myToggle"
            >Primary {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="secondary" :pressed.sync="myToggle"
            >Secondary {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="success" :pressed.sync="myToggle"
            >Success {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="info" :pressed.sync="myToggle"
            >Info {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="warning" :pressed.sync="myToggle"
            >Warning {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="danger" :pressed.sync="myToggle"
            >Danger {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
        </b-card>
        ...
        <b-card>
          ...
          <b-button size="lg" variant="secondary" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="primary" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="success" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="info" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="warning" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="danger" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="link" :block="true"
            >Block level button</b-button
          >
        </b-card> </b-col
      ><!--/.col-->
      <b-col md="6">
        ...
        <b-card>
          ...
          <b-button variant="outline-primary" :disabled="true"
            >Primary</b-button
          >
          ...
          <b-button variant="outline-warning" :disabled="true"
            >Warning</b-button
          >
        ...
        <b-card>
          ...
          <b-button variant="outline-secondary" :active="true"
            >Secondary</b-button
          >
        ...
        <b-card>
          ...
          <b-button variant="outline-secondary" :pressed="true"
            >Secondary</b-button
          >
        ...
        <b-card>
          ...
          <b-button variant="outline-primary" :pressed.sync="myToggle"
            >Primary {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="outline-secondary" :pressed.sync="myToggle"
            >Secondary {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="outline-success" :pressed.sync="myToggle"
            >Success {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="outline-info" :pressed.sync="myToggle"
            >Info {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="outline-warning" :pressed.sync="myToggle"
            >Warning {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
          <b-button variant="outline-danger" :pressed.sync="myToggle"
            >Danger {{ myToggle ? 'On ' : 'Off' }}</b-button
          >
        </b-card>
        <b-card>
          ...
          <b-button size="lg" variant="outline-secondary" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="outline-primary" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="outline-success" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="outline-info" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="outline-warning" :block="true"
            >Block level button</b-button
          >
          <b-button size="lg" variant="outline-danger" :block="true"
            >Block level button</b-button
          >
        </b-card> </b-col
      ><!--/.col--> </b-row
